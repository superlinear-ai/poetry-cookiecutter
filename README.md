...
| `processing_unit`                  <br> ["CPU","GPU]                                        | The processing unit we want to use. If GPU is choosen the CUDA Toolkit and CuDNN library are installed and configured to handle a GPU. We support CUDA Toolkit 11.8 with python versions 3.8, 3.9, 3.10.                                                                                                                                                                                                                                                                                                                                             |
